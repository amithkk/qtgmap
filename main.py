...
if __name__ == '__main__':
    ...
    gmap.centerAt(13.021575727448424,77.59541898965836)
    gmap.setZoom(13)
    coords = gmap.centerAtAddress("RT Nagar")
    # Many icons at: https://sites.google.com/site/gmapsdevelopment/
    gmap.addMarker("SatelliteMarker", *coords, **dict(
    ...
    settings.setFontFamily(QtWebKit.QWebSettings.StandardFont, 'Calibri')
